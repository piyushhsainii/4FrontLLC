        ...
        <div className="flex flex-col gap-8 md:gap-24">
          {processSteps.map((step, idx) => (
            <motion.div
              ...
              className={`sticky top-32 flex flex-col items-center gap-8 rounded-3xl border border-black/5 bg-white p-8 md:p-12 shadow-[0_8px_30px_rgb(0,0,0,0.04)] ${idx % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'
                }`}
              style={{
