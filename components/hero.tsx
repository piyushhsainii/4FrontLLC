    ...
    <section className="relative z-10 flex h-[100vh] max-h-[800px] flex-col justify-center px-6 pt-24 text-center mt-20 lg:mt-0">
      ...
      <div className="mx-auto max-w-4xl z-10">
        ...
        <div className="flex flex-col items-center justify-center gap-6 sm:flex-row">
          <a
            href="#contact"
            className="w-full rounded-full bg-primary border-2 border-primary px-8 py-4 text-base font-semibold text-primary-foreground transition-all shadow-[6px_6px_0px_var(--green)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[4px_4px_0px_var(--green)] active:translate-x-[6px] active:translate-y-[6px] active:shadow-none sm:w-auto"
          >
            Get a Free Roof Inspection
          </a>
          <a
            href="#projects"
            className="w-full rounded-full border-2 border-accent bg-transparent px-8 py-4 text-base font-semibold text-accent transition-colors hover:bg-accent/10 hover:shadow-lg sm:w-auto"
          >
